        ...
        {todos.length > 0 && (
          <>
              ...
              <div className="todo" key={individualTodo.ID}>
                ...
                <div>
                  {editForm===false && (
                    ...
                    onChange={()=>handlerCheckbox(individualTodo.ID)}/>

                  )}
                  <span style={individualTodo.completed===true?
                  {textDecoration:'line-through'}:{textDecoration:'none'}}>{individualTodo.TodoValue}</span>
                </div>
                ...
                <div className="edit-and-delete">
                  ...
                  <div onClick={() => handledel(individualTodo.ID)}>
            ...
            <div style={{display:'flex',justifyContent:'flex-end'}}>
              <button onClick={()=>setTodos([])} className='delete-all'>DELETE ALL</button>
            </div>
          </>
        )}
